...
public class CabmeActivity extends Activity {
	...
	private OnClickListener mBookListener = new OnClickListener() {
		public void onClick(View view) {
			...
			Bundle b = new Bundle();
			b.putBoolean(Common.NEWBOOKING_FLAG, true);
			intent.putExtras(b);
	...
	private OnClickListener mViewBookingsListener = new OnClickListener() {
		public void onClick(View view) {
			Intent intent = new Intent(CabmeActivity.this,
					BookingListActivity.class);
			Bundle b = new Bundle();
			b.putBoolean(Common.REVIEW_FLAG, false);
			intent.putExtras(b);
			startActivity(intent);
		}
	};
	private OnClickListener mReviewListener = new OnClickListener() {
		public void onClick(View view) {
			Intent intent = new Intent(CabmeActivity.this,
					BookingListActivity.class);
			Bundle b = new Bundle();
			b.putBoolean(Common.REVIEW_FLAG, true);
			intent.putExtras(b);
			startActivity(intent);
		}
	};
	private OnClickListener mSettingsListener = new OnClickListener() {
		public void onClick(View view) {
			Toast.makeText(CabmeActivity.this, "Launching settings Activity",
